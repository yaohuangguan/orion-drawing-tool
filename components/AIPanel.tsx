...
export const AIPanel: React.FC<AIPanelProps> = ({ currentCode, onCodeGenerated }) => {
    ...
    <div className="flex flex-col h-64 bg-gray-850 border-t border-gray-700 p-4">
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-sm font-semibold text-gray-300 flex items-center gap-2">
          ...
          AI Generator (Gemini 3 Pro)
        </h3>
        {state.status === 'thinking' && (
          <span className="text-xs text-purple-400 animate-pulse">Thinking deeply...</span>
        )}
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-2">
        <div className="relative flex-1">
          <textarea
            ...
            placeholder="Describe the SVG you want (e.g., 'A futuristic neon city icon' or 'Change the circle color to red')"
